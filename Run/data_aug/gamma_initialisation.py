...
path = '/data_hd1/data/eyes/gamma_2021/task3_disc_cup_segmentation/'
train_path = os.path.join(path,'training')
image_path = os.path.join(train_path,'fundus color images')
mask_path = os.path.join(train_path,'Disc_Cup_Mask')
...
create_dir('/home/kebl6872/Desktop/new_data/Gamma2/train/image/')
create_dir('/home/kebl6872/Desktop/new_data/Gamma2/train/mask/')
save_path = '/home/kebl6872/Desktop/new_data/Gamma2/train'
#
